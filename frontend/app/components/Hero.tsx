        ...
        <section className="bg-slate-200 px-5 sm:px-[10%] my-10 h-full">
            <div className="flex flex-col sm:flex-row items-center justify-between w-full">
                ...
                <div className="flex-1 text-center sm:text-left">
                    ...
                    <div 
                        className="text-blue-900 scale-90 sm:scale-125 text-base"
                    ...
                    <div
                        className="flex flex-col sm:flex-row items-center sm:space-x-4 w-full sm:w-fit scale-100 sm:scale-125 mb-36 mt-12"
                        style={{ minHeight: "60px" }} 
                    >
                        {data.button.map((btnText, idx) => (
                            <button
                                key={idx}
                                className="bg-gray-800 text-white px-6 py-2 mt-8 sm:mt-0 rounded-full hover:bg-red-700"
                            >
                                {btnText}
                            </button>
                        ))}
            ...
            <p
                className="text-blue-900 text-justify mt-10 sm:mt-20 text-sm sm:text-2xl"

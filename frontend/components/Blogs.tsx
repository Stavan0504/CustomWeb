      ...
      <div className="relative px-5 py-16 overflow-y-hidden bg-gradient-to-br from-blue-400 via-sky-200 to-pink-500">
        <div className="flex flex-col items-center min-h-screen">
          <div className="py-16 text-center">
            ...
            <div className="max-w-3xl mx-auto text-4xl sm:text-6xl text-gray-700">
              <PortableText value={data.description} components={customComponents} />
            </div>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 px-4 sm:px-10">
          ...
          <button className="flex justify-center bg-red-900 rounded-full mt-5 w-50 p-5 text-lg font-bold text-white hover:bg-sky-950 hover:text-white transition-all duration-500 h-12 py-3">
            {data.button}
          </button>
        </div>
      </div>
